...
void mainLoop() {
	...
	transMat.at<float>(0,0)=3.127707204839680344e-04*1000;
	transMat.at<float>(0,1)=2.411879759165458381e-04*1000;
	transMat.at<float>(0,2)=-9.514510650963832212e-04*1000;
	transMat.at<float>(0,3)=2.644506772359212050e+02;
	transMat.at<float>(1,0)=-2.443285041711836252e-04*1000;
	transMat.at<float>(1,1)=-9.311167717290420604e-04*1000;
	transMat.at<float>(1,2)=-3.046750680368859321e-04*1000;
	transMat.at<float>(1,3)=1.784243663152058730e+02;
	transMat.at<float>(2,0)=9.524971537757664919e-04*1000;
	transMat.at<float>(2,1)=-3.339596842124592513e-04*1000;
	transMat.at<float>(2,2)=2.206901068954418013e-04*1000;
